...
import org.mixedsignals.resignal.jobmanager.impl.NetworkOrCellServiceConstraint;
import org.mixedsignals.resignal.jobmanager.impl.CellServiceConstraint;
...
public class SmsSendJob extends SendJob {
  ...
  public static class Factory implements Job.Factory<SmsSendJob> {
    @Override
    public @NonNull SmsSendJob create(@NonNull Parameters parameters, @NonNull org.mixedsignals.resignal.jobmanager.Data data) {
