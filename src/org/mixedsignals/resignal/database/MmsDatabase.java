...
import org.mixedsignals.resignal.attachments.AttachmentId;
import org.mixedsignals.resignal.attachments.DatabaseAttachment;
import org.mixedsignals.resignal.attachments.MmsNotificationAttachment;
...
import org.mixedsignals.resignal.database.documents.IdentityKeyMismatchList;
import org.mixedsignals.resignal.database.documents.NetworkFailure;
import org.mixedsignals.resignal.database.documents.NetworkFailureList;
import org.mixedsignals.resignal.database.helpers.SQLCipherOpenHelper;
...
import org.mixedsignals.resignal.database.model.NotificationMmsMessageRecord;
...
import static org.mixedsignals.resignal.contactshare.Contact.Avatar;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.mixedsignals.resignal.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.mixedsignals.resignal.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.mixedsignals.resignal.util.Util.toIsoBytes(transactionId);
