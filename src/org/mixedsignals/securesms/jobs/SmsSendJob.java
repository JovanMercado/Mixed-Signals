...
import org.mixedsignals.securesms.service.SmsDeliveryListener;
import org.mixedsignals.securesms.transport.UndeliverableMessageException;
import org.mixedsignals.securesms.util.NumberUtil;
...
public class SmsSendJob extends SendJob {
  ...
  public static class Factory implements Job.Factory<SmsSendJob> {
    @Override
    public @NonNull SmsSendJob create(@NonNull Parameters parameters, @NonNull org.mixedsignals.securesms.jobmanager.Data data) {
