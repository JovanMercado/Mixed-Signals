...
import org.mixedsignals.securesms.database.model.SmsMessageRecord;
...
import org.mixedsignals.securesms.sms.IncomingGroupMessage;
...
public class SmsDatabase extends MessagingDatabase {
  ...
  protected Optional<InsertResult> insertMessageInbox(IncomingTextMessage message, long type) {
    ...
    boolean    unread     = (org.mixedsignals.securesms.util.Util.isDefaultSmsProvider(context) ||
