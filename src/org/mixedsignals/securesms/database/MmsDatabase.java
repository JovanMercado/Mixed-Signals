 ...
 */
package org.mixedsignals.securesms.database;
...
import org.mixedsignals.securesms.attachments.MmsNotificationAttachment;
...
import org.mixedsignals.securesms.database.documents.IdentityKeyMismatchList;
import org.mixedsignals.securesms.database.documents.NetworkFailure;
import org.mixedsignals.securesms.database.documents.NetworkFailureList;
import org.mixedsignals.securesms.database.helpers.SQLCipherOpenHelper;
...
import org.mixedsignals.securesms.database.model.NotificationMmsMessageRecord;
...
import static org.mixedsignals.securesms.contactshare.Contact.Avatar;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.mixedsignals.securesms.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.mixedsignals.securesms.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.mixedsignals.securesms.util.Util.toIsoBytes(transactionId);
