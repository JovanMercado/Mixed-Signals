package org.mixedsignals.securesms.avatar;
...
import org.mixedsignals.securesms.util.IntentUtils;
...
public final class AvatarSelection {
  ...
  private static Intent createAvatarSelectionIntent(Context context, @Nullable File tempCaptureFile, boolean includeClear) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("org.mixedsignals.securesms.action.CLEAR_PROFILE_PHOTO"));
    }
