...
import org.mixedsignals.securesms.push.IasTrustStore;
import org.mixedsignals.securesms.recipients.Recipient;
import org.mixedsignals.securesms.sms.IncomingJoinedMessage;
import org.mixedsignals.securesms.util.concurrent.SignalExecutors;
...
public class DirectoryHelper {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("org.mixedsignals.securesms");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "org.mixedsignals.securesms");
