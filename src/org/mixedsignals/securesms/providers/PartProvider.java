...
import org.mixedsignals.securesms.mms.PartUriParser;
import org.mixedsignals.securesms.service.KeyCachingService;
import org.mixedsignals.securesms.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.mixedsignals.provider.securesms/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.mixedsignals.provider.securesms", "part/*/#", SINGLE_ROW);
  }
